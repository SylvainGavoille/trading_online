"""
Quantum Trader - Multi-LLM Trading System
Powered by DSPy - Supports OpenAI, Anthropic, Ollama, and more
"""
import argparse
import yaml
import logging
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='Quantum Trader - Multi-LLM Trading System powered by DSPy'
    )
    parser.add_argument(
        '--symbols',
        nargs='+',
    ...
    # Afficher bannière
    print("=" * 70)
    print("       QUANTUM TRADER - Multi-LLM Trading System")
    print("       Powered by DSPy Framework")
    print("=" * 70)
